...
#define KERN_SIZE_OF_PAGE  0x1000
...
/**
    Frees the allocated memory buffer.

    @param[in] Data    The pointer to the start of the first page.
    @param[in] Size    The size of the buffer to free (in bytes).
 **/
VOID
kfree (
  IN VOID   *Data,
